...
| `DESIGN-android.md` | Jetpack Compose implementation — `Color` tokens, Material 3 `Typography`, composables, per-action color micro-animations + column-centered feed + Haptics |
